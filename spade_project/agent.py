...
async def main():
    ...
    print("Initializing StationAgents...")
    station_agents = []
    for idx, station in stations_data.iterrows():
        station_jid = "station@jabbim.com/" + station['station_name'] #str(idx)
    ...
    for agent in station_agents:
        await agent.start()
    print("All StationAgents finished.")
    ...
    for idx, ride in rides_data.iterrows():
        ...
        add_or_update_bike(idx, ride['start_station_id'])
